...
export function supportTicketEmail({ employee, subject: ticketSubject }) {
  const subject = `Support request — ${ticketSubject} (${employee.employeeId})`;
            ...
            <tr>
              <td style="padding:36px 32px 8px;">
                ...
                <p style="margin:0 0 24px;font-size:14.5px;line-height:1.65;color:#3F4451;">
                  A support request was submitted from the employee portal.
                </p>
              </td>
            </tr>
